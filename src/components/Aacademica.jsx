        ...
        <div className="my-24 md:px-14 px-4 max-w-screen-2xl mx-auto" id='Aacademica'>
            <div className="flex flex-col lg:flex-row justify-between items-start gap-10">
                <motion.div
                    ...
                    className="lg:w-1/4">
                    <h1 className="text-3xl font-bold mb-3">Actividades Académicas</h1>
                    <p className="text-base text-justify text-tartiary">Los estudiantes participan en proyectos de investigación y desarrollo de software, así como en prácticas
                        profesionales que les permiten aplicar sus habilidades en entornos reales. Además, la carrera promueve el trabajo en equipo y el aprendizaje colaborativo,
                        preparando a los estudiantes para enfrentar los desafíos del mundo tecnológico actual.</p>
                </motion.div>
                {/*cards*/}
