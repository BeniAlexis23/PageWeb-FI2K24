        ...
        <div className="my-24 md:px-14 px-4 max-w-screen-2xl mx-auto" id='feature'>
            <div className="flex flex-col lg:flex-row justify-between items-start gap-10">
                <motion.div
                    ...
                    className="lg:w-1/4">
                    <h3 className="text-3xl font-bold lg:w-1/2 mb-3">Otra pagina para la pagina de UNDC</h3>
                    <p className="text-base text-tartiary">afadnvuadncadljafuahldfauefheqjfhajf ashfdjfh jdfdfjdkfjdfd  jfdkfjdkfjd fdfjkdfjdkfdjfk dfoerie</p>
                </motion.div>
                {/*cards*/}
                <motion.div
                    ...
                    <div className='grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 items-start md:gap-12 gap-8'>
                        <div className='bg-[rgba(255, 255, 255, 0.04)] rounded-[35px] h-96 shadow-3xl p-8 items-center flex justify-center hover:-translate-y-4 transition-all duration-300 cursor-pointer'>
                            <div>
                                <img src={featureImg} alt="" className='lg:h-[386px]' />
                                <h5 className='text-2xl font-semibold px-5 text-center mt-5'>Concurso de programacion</h5>
                            </div>
                        </div>
